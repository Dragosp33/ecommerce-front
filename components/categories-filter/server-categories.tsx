  ...
  return (
    <div className=''>
      ...
      {category.children && category.children.length > 0 ? (
        <Collapsible>
          <CollapsibleTrigger className='group flex w-full items-center justify-between gap-4 px-2 py-2 text-sm font-small [&[data-state=open]>svg]:rotate-90'>
            {category.name}
